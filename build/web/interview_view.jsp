<%-- 
    Document   : interview_view
    Created on : Nov 22, 2016, 11:13:59 AM
    Author     : nuwan
--%>
...
<div class="page">
    <div class="page-header">
        <h1 class="page-title">Interview Applications Details</h1>
        <ol class="breadcrumb">
            <li><a href="admin_dashboard.jsp">Dashboard</a></li>
            <li><a href="interviews.jsp">Interviews</a></li>
            <li class="active">Check Interview Applications</li>
        </ol>
    </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="wizard-content" id="application_view_form" name="application_view_form" method="post" action="ChangeApplicationDetails">
                                            ...
                                            <div class="wizard-pane active" role="tabpanel">
                                                <h3 class="img-responsive panel-title"><b>Bachelor of Arts General(External) Degree Programme Interviews - 2017</b></h3>
                                                <br>

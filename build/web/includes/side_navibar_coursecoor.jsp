<%-- 
    Document   : side_navibar_coursecoor
    Created on : Jan 19, 2017, 2:26:43 PM
    Author     : nuwan
--%>
                ...
                <ul class="site-menu">
                    ...
                    <li class="site-menu-item">
                        <a class="animsition-link" href="" data-slug="layout-two-columns">
                            ...
                            <span class="site-menu-title">Verify Data Entry</span>
                        </a>
                    </li>
                    ...
                    <li class="site-menu-item">
                        <a class="animsition-link" href="" data-slug="layout-two-columns">
                            ...
                            <span class="site-menu-title">Monitor Course Progress</span>
                        </a>
                    </li>
                    ...
                    <li class="site-menu-item">
                        <a class="animsition-link" href="" data-slug="layout-two-columns">
                            <i class="site-menu-icon icon wb-user" aria-hidden="true"></i>
                            <span class="site-menu-title">Assign Course</span>
                        </a>
                    </li>
                    ...
                    <li class="site-menu-item">
                        <a class="animsition-link" href="" data-slug="layout-two-columns">
                            <i class="site-menu-icon icon wb-payment" aria-hidden="true"></i>
                            <span class="site-menu-title">Create Degree</span>
                        </a>
                    </li>
                    ...
                    <li class="site-menu-item">
                        <a class="animsition-link" href="" data-slug="layout-two-columns">
                            <i class="site-menu-icon icon wb-payment" aria-hidden="true"></i>
                            <span class="site-menu-title">Manage Course Subjects</span>
                        </a>
                    </li>

<%-- 
    Document   : shroff_dashboard
    Created on : Jan 19, 2017, 12:31:14 PM
    Author     : nuwan
--%>
...
<div class="page">
    <div class="page-content">
        <h2>Shroff <small>Dashboard</small></h2>
                ...
                <a href="#"><div class="col-lg-2 col-md-4 col-sm-4">
                        ...
                        <div class="panel panel-bordered" align="center">
                            <div class="panel-body">
                                <h4></h4>
                                <!--code>.panel-footer</code--><img class="img-responsive" src="assets/images/reports.png">
                            </div>
                            <div class="panel-footer" style="text-align:center">Generate Reports</div>
                        </div>
                    </div></a>
                ...
                <a href="#"><div class="col-lg-2 col-md-4 col-sm-4">
                        ...
                        <div class="panel panel-bordered" align="center">
                            <div class="panel-body" align="center">
                                <h4></h4>
                                <!--code>.panel-footer</code--><img class="img-responsive" src="assets/images/vouchers.png">
                            </div>
                            <div class="panel-footer" style="text-align:center">Issue Vouchers</div>
                        </div>
                    </div></a>
            </div>
        </div>

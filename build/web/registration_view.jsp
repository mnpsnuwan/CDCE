<%-- 
    Document   : registration_view
    Created on : Nov 22, 2016, 10:14:59 AM
    Author     : nuwan
--%>
...
<div class="page">
    <div class="page-header">
        <h1 class="page-title">Registration Applications Details</h1>
        <ol class="breadcrumb">
            <li><a href="admin_dashboard.jsp">Dashboard</a></li>
            <li><a href="registration.jsp">Registration</a></li>
            <li class="active">Selected Applications</li>
        </ol>
    </div>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <ul class="nav nav-tabs">
                    ...
                    <li><a data-toggle="tab" href="#venue">Examinations</a></li>
                    <li><a data-toggle="tab" href="#index">Payments</a></li>
                </ul>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="wizard-content" id="application_view_form" name="application_view_form" method="post" action="ChangeApplicationDetails">
                                            ...
                                            <div class="wizard-pane active" role="tabpanel">
                                                <h3 class="img-responsive panel-title"><b>Bachelor of Arts General(External) Degree Programme Registration - 2017</b></h3>
                                                <br>

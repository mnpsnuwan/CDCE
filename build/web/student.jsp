<%-- 
    Document   : student
    Created on : Jan 27, 2017, 12:04:59 PM
    Author     : nuwan
--%>
    ...
    <div class="page-content">
        ...
        <div class="panel">
            <header class="panel-heading">
                <h4 class="panel-title">Student Info Registered Students <span class="tooltip-dark" data-toggle="tooltip" data-original-title="Help tips" data-trigger="focus / hover"><button type="button" class="btn-info popover-info btn-sm btn-icon btn-inverse btn-info btn-round" data-content="Can search any content of the table. And also can view fully application through the id." data-toggle="popover" data-original-title="About this table..." data-trigger="click"><i class="grey-500 icon wb-info"></i></button></span></h4>
            </header>
            <div class="panel-body">
                <table class="table table-hover dataTable table-striped width-full" id="exampleTableSearch">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="student_view.jsp?action=edit&id=<%=applications.getId()%>" class="tooltip-dark btn btn-sm btn-icon btn-inverse btn-round" data-toggle="tooltip" data-original-title="View fully Application details for <%=applications.getFullName()%>" data-trigger="focus / hover"><%=applications.getId()%></a></td>  

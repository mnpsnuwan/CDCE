<%-- 
    Document   : side_navibar_shroff
    Created on : Jan 19, 2017, 12:31:43 PM
    Author     : nuwan
--%>
            ...
            <div>
                <ul class="site-menu">
                    <li class="site-menu-item">
                        <a class="animsition-link" href="../CDCE/shroff_dashboard.jsp" data-slug="dashboard-v1">
                    ...
                    <li class="site-menu-item">
                        <a class="animsition-link" href="" data-slug="layout-two-columns">
                            ...
                            <span class="site-menu-title">Generate Reports</span>
                        </a>
                    </li>
                    ...
                    <li class="site-menu-item">
                        <a class="animsition-link" href="" data-slug="layout-two-columns">
                            ...
                            <span class="site-menu-title">Issue Vouchers</span>
                        </a>
                    </li>
...
<div class="site-gridmenu">
    <ul>
        ...
        <li>
            <a href="../CDCE/shroff_dashboard.jsp">
